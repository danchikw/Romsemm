        ...
        <header className="header">
            <div className="header__left">
                <div className="header__phone">
                    ...
                    <a className="header__phone-tel" href="tel:+996 709 78 45 72">+996 709 78 45 72</a>
                    <a className="header__phone-tel" href="tel:+996 554 68 68 07">+996 554 68 68 07</a>
            ...
            <div className="header__right">
                <ul className="header__list">
                    <li className="header__list-item">
                        <Link className="header__link1" to="/">Отзывы</Link>
                    </li>
                    <li className="header__list-item">
                        <Link className="header__link2" to="/">Доставка и оплата</Link>
                    </li>
                </ul>
